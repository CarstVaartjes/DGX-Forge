...
from ...models.publication_export_request import PublicationExportRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/catalog/recipes/{recipe_id}/publication-export".format(recipe_id=recipe_id,),
    }
