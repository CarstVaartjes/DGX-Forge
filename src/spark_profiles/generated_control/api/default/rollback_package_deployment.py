...
from ...models.package_plan_request import PackagePlanRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/deployments/{deployment_id}/rollouts/{rollout_id}/rollback".format(deployment_id=deployment_id,rollout_id=rollout_id,),
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[BoundedErrorResponse, PackageProgressResponse]]:
    if response.status_code == 202:
        response_202 = PackageProgressResponse.from_dict(response.json())
