...
T = TypeVar("T", bound="PackageCandidateResponseMetadata")



@_attrs_define
class PackageCandidateResponseMetadata:
    """
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        package_candidate_response_metadata = cls(
        )
        ...
        package_candidate_response_metadata.additional_properties = additional_properties
        return package_candidate_response_metadata
