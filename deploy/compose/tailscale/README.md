...
continuously reconciles and advertises only the three explicit Services. It uses
the explicit `--https=443` CLI form and verifies that Serve status reports
HTTPS, never plaintext HTTP, on port 443.
