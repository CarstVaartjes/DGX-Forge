...
export function FleetPage({api}: {api: ControlApi}) {
  ...
  return <>
    ...
    <div className="table-scroll"><table aria-label="Vonk Forge GPU nodes">
      <caption>Vonk Forge GPU nodes</caption>
    ...
    {fleet && fleet.nodes.length === 0 && <p>No GPU nodes are registered yet. Use the onboarding CLI to add the first node.</p>}
  </>;
}
