...
export function CatalogPage({api}: {api: CatalogListApi}) {
  ...
  return <>
    <div className="page-heading"><div><h2>Recipe catalog</h2><p>Local PostgreSQL is authoritative. Recipes remain available when vonkforge.ai or Git is unavailable.</p></div><a className="button" href="/catalog/new">Create local recipe</a></div>
