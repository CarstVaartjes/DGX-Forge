...
function documentFrom(fields: Fields): CatalogRecipeDocument {
  return {
    ...
    runtime: {family: fields.runtimeFamily, image: fields.runtimeImage, architecture: "linux/arm64", arguments: []},
    ...
    security: {devices: ["nvidia.com/gpu=all"], capabilities: [], host_network: false, privileged: false, mounts: [{source: "model", target: "/models", read_only: true}]}, provenance: {source_kind: "local", source_reference: null, attribution: []},
  };
}
