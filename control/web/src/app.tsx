...
import type {ControlApi} from "./api/types"; import {FleetPage} from "./pages/fleet"; import {ProfilesPage} from "./pages/profiles"; import {ModelsPage} from "./pages/models"; import {JobsPage} from "./pages/jobs"; import {AuditPage} from "./pages/audit";
const pages = ["fleet", "profiles", "models", "jobs", "audit"] as const;
...
export function App({api}: {api: ControlApi}) {
  ...
  const content = {fleet: <FleetPage api={api}/>, profiles: <ProfilesPage api={api}/>, models: <ModelsPage api={api}/>, jobs: <JobsPage api={api}/>, audit: <AuditPage api={api}/>}[page];
