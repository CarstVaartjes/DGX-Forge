...
test("explains every omitted or blocked source field", () => {
  render(<ImportReport items={[
    {source_path: "/mods/0", disposition: "unsupported_blocking", destination_path: null, reason_code: "sparkrun.mods_unsupported", detail: "Mods cannot execute from a recipe; publish the behavior in a container.", blocking: true},
