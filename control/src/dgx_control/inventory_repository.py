...
class InventorySnapshotInput:
    ...
    fabric_address: str | None = None; fabric_bandwidth_mbps: int | None = None
    nvidia_driver_version: str = "unknown"; container_runtime_version: str = "unknown"
...
class InventorySnapshotView:
    ...
    fabric_address: str | None; fabric_bandwidth_mbps: int | None; nvidia_driver_version: str; container_runtime_version: str
...
class InventoryRepository:
    ...
    def record(self, value: InventorySnapshotInput) -> NodeInventorySnapshot:
        ...
        if value.fabric_address is not None:
            ...
            if str(address) != value.fabric_address or not value.fabric_bandwidth_mbps or value.fabric_bandwidth_mbps > 1_000_000:
                raise ValueError("inventory fabric address is invalid")
        if any(not value or len(value) > 256 or not value.isascii() for value in (value.nvidia_driver_version, value.container_runtime_version)):
