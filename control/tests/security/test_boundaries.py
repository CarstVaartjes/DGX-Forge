...
def proposals(tmp_path: Path):
    ...
    (root / "config/workloads/base.toml").write_text('schema_version = 2\nid = "base"\nname = "Base"\n')
...
def test_repository_content_cannot_select_executable_or_network_target(proposals, document) -> None:
